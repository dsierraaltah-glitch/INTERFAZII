...
void setup() {
  ...
  Serial.println("minna mafumafu da! 皆、"まふまふ"だ―~"); // Envía "Hola, Mundo!" al monitor serie
}
...
void draw() {
  background(245, 245, 220); // Fondo negro
  fill(72, 209, 204);     // Color blanco para el texto
